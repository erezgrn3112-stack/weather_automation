...
def run_weather_logger():
    # Security: Fetching the OpenWeather API key from environment variables (GitHub Secrets)
    api_key = os.getenv("WEATHER_API_KEY")
    if not api_key:
        print("Error: WEATHER_API_KEY not found.")
        return

    # Configuration: Global list of 40 strategic business and travel destinations
    cities = [
        ...
        {"name": "Buenos Aires", "lat": -34.6037, "lon": -58.3816, "continent": "South America", "country": "Argentina"},
    ...
    # Data Schema: Defining columns for the historical database
    ...
    # Persistence: Appending new hourly records to the existing CSV dataset
    with open('weather_data.csv', mode='a', newline='', encoding='utf-8') as csvfile:
        ...
        for city in cities:
            ...
            try:
                ...
                # Transformation: Calculating local time and mapping API response to our schema
                weather_row = {
...
if __name__ == "__main__":
    # Script entry point for automated execution
    run_weather_logger()
